...
const resOptions2: IResourceOptions = {
  initialState: new DataResource({
    tracks: [3, 4, 5],
...
describe('Ng Resource Store', () => {
  ...
  it('should load tracks, columns and the whole resource from the resource store instance', () => {
    ...
    expect(dirInst1.context.tracks.value).toEqual(res1.tracks.value);
    expect(dirInst2.context.tracks.value).toEqual(res2.tracks.value);
  ...
  it('should load tracks, columns and the whole resource from the resource store key', () => {
    ...
    expect(dirKey1.context.tracks.value).toEqual(res1.tracks.value);
    expect(dirKey2.context.tracks.value).toEqual(res2.tracks.value);
